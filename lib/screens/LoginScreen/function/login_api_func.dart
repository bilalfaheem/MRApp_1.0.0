...
Future<void> loginPostApi(
  ...
  final response =
      await post(Uri.parse('${apiAddress}gas_user_login.php'), body: {
    "phone": cnic,
    'password': password,
  });
...
// validate
    ...
    if (L_status == 1) {
      ...
      final userLoginDataResponse = userLoginData;
      ...
      pref.setString("readerSociety", userLoginDataResponse[0]["project_title"]);
      pref.setString(
