...
Future addGasReadingFunc(context, theme, File imageFile, addressId,
    previousReading, currentReading) async {
// ignore: deprecated_member_use
  print(
      "address ID$addressId previousReading$previousReading currentReading$currentReading");
  final gasReaderProvider =
...
Future readerApi(context, theme, String readerId, String addressId,
    String previousReader, String currentReading) async {
  ...
  final Response =
      await http.post(Uri.parse("${apiAddress}create_gas_bill.php"), body: {
    "g_user_id": readerId,
